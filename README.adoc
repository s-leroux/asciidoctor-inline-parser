...
ifdef::status[]
.*Project health*
image:https://travis-ci.org/s-leroux/asciidoctor-inline-parser.svg?branch=master[Build Status (Travis CI), link=https://travis-ci.org/s-leroux/asciidoctor-inline-parser]
endif::[]
